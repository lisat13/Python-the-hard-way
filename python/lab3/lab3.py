...
gruppe = {  'student1': 'Lisa tvedt', \
			'student2': 'Marte holen', \
            'student3': 'Mats Skandsen', \
}
...
#       byteorder: little
#       os data: 
#       ('Linux', 'LapperT', '2.6.32-431.3.1.el6.x86_64', '#1 SMP Fri Jan 3 21:39:27 UTC 2014', 'x86_64')
#       os bruker: Johan
...
def initialer(navn):
    ...
    for line in name_split:
        print(line[0][0].uppe() +'.'
initialer ("Lisa Tvedt")
initialer ("Marte Holen")
initialer ("Mats Skandsen")
